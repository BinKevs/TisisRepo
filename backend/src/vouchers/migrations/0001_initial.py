    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('claimed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_accouunt_voucher', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
